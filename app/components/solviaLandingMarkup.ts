          ...
          <div class="bc-frame" data-bcarousel style="position:relative;">
            ...
            <div class="bc-mask" data-row="0" style="margin-bottom:18px;">
              <div class="bc-track" data-track>
                ...
                <a class="bc-card" href="/mpoint" style="background:#0e1c2c;"><span style="position:absolute; top:18px; left:20px; z-index:3; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:#4f96d6; color:#07131f;">Devices</span><div class="bc-cell" style="align-items:center; justify-content:center; text-align:center; gap:18px;"><img src="/assets/mpoint/MPOINT_Device_Hero_Transparent.png" alt="MPOINT" style="max-width:80%; max-height:64%; object-fit:contain;"><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">MPOINT</h3></div></a>
