          ...
          <div class="bc-frame" data-bcarousel style="position:relative;">
            ...
            <div class="bc-mask" data-row="0" style="margin-bottom:18px;">
              <div class="bc-track" data-track>
                ...
                <a class="bc-card" href="/n-mode-f" style="background:#f3ecdf; color:#3a2b28;"><div style="position:absolute; inset:0; background:linear-gradient(165deg,#f7f1e6 0%,#eadfc9 55%,#dcc9a6 100%);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:#3a2b28; color:#f6ece4;">Functional</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">N MODE F</h3><span style="font-size:10px; letter-spacing:0.18em; color:#9a7d35;">KR · Global</span></div></div></a>
              </div>
            </div>
