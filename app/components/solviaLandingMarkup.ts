// header element (rendered outside <main>)
export const headerMarkup = String.raw`
...
// HERO · THE NAME · JOURNEY · PRODUCTS — complete section elements
export const sectionsBefore = String.raw`
    <!-- HERO -->
...
// GLOBAL · CTA · FOOTER — complete elements
export const sectionsAfter = String.raw`
    <!-- GLOBAL -->
