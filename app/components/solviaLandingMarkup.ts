          ...
          <div class="bc-frame" data-bcarousel style="position:relative;">
            ...
            <div class="bc-mask" data-row="0" style="margin-bottom:18px;">
              <div class="bc-track" data-track>
                ...
                <a class="bc-card" href="/mpoint" style="background:#0e1c2c;"><span style="position:absolute; top:18px; left:20px; z-index:3; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:#4f96d6; color:#07131f;">Devices</span><div class="bc-cell" style="align-items:center; justify-content:flex-end; text-align:center; gap:16px; padding-bottom:22px;"><img src="/assets/mpoint/MPOINT_Device_Hero_Transparent.png" alt="MPOINT" style="max-width:80%; max-height:62%; object-fit:contain;"><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">MPOINT</h3></div></a>
                ...
                <a class="bc-card" data-brand="seran" style="background:#3a2b28;"><div style="position:absolute; inset:0; background:repeating-linear-gradient(135deg,#3a2b28,#3a2b28 17px,#33251f 17px,#33251f 34px);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:rgba(255,253,249,0.16); border:1px solid rgba(255,253,249,0.28);">Cosmetics</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">SERAN</h3></div></div></a>
              </div>
            </div>
            ...
            <div class="bc-mask" data-row="1">
              <div class="bc-track" data-track>
                <a class="bc-card" data-brand="pulse"><img class="bc-img" src="/assets/golden-sky.webp" alt="Pulse"><div style="position:absolute; inset:0; background:linear-gradient(160deg,rgba(20,24,14,0.34),rgba(20,24,14,0.08) 42%,rgba(20,24,14,0.86));"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:rgba(238,240,228,0.16); border:1px solid rgba(238,240,228,0.28);">Devices</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">PULSE</h3></div></div></a>
                <a class="bc-card" href="/coreslim" style="background:#fff; color:#3a2b28;"><img class="bc-img" src="/assets/coreslim/hero.png" alt="CoreSlim" style="object-fit:contain; padding:14px 14px 70px;"><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:#3a2b28; color:#f6ece4;">Devices</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">CORESLIM</h3></div></div></a>
                <a class="bc-card" data-brand="novelume" style="color:#3a2b28;"><div style="position:absolute; inset:0; background:repeating-linear-gradient(135deg,#e6d8bd,#e6d8bd 17px,#ddcdae 17px,#ddcdae 34px);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:#3a2b28; color:#f6ece4;">Cosmetics</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">NOVELUME</h3></div></div></a>
                <a class="bc-card" data-brand="eclat" style="background:#3a2b28;"><div style="position:absolute; inset:0; background:repeating-linear-gradient(135deg,#3a2b28,#3a2b28 17px,#33251f 17px,#33251f 34px);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:rgba(255,253,249,0.16); border:1px solid rgba(255,253,249,0.28);">Cosmetics</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">ÉCLAT</h3></div></div></a>
                <a class="bc-card" data-brand="derma-v" style="background:#3a2b28;"><div style="position:absolute; inset:0; background:repeating-linear-gradient(135deg,#333f2e,#333f2e 17px,#2c3628 17px,#2c3628 34px);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:rgba(255,253,249,0.16); border:1px solid rgba(255,253,249,0.28);">Functional</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">DERMA-V</h3></div></div></a>
                <a class="bc-card" data-brand="regena" style="background:#3a2b28;"><div style="position:absolute; inset:0; background:repeating-linear-gradient(135deg,#333f2e,#333f2e 17px,#2c3628 17px,#2c3628 34px);"></div><div class="bc-cell"><span style="align-self:flex-start; font-size:9px; letter-spacing:0.22em; text-transform:uppercase; padding:6px 12px; border-radius:999px; background:rgba(255,253,249,0.16); border:1px solid rgba(255,253,249,0.28);">Functional</span><div><h3 style="font-family:'Jost',sans-serif; font-weight:500; font-size:28px; letter-spacing:0.06em; margin:0;">REGENA</h3></div></div></a>
              </div>
            </div>
          </div>
